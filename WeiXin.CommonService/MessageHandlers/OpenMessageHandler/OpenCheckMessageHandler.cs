...
using WeiXin.CommonService.CustomMessageHandler;
using Senparc.Weixin.MP.Entities.Request;
using WeiXin.CommonService.OpenTicket;
using WeiXin.CommonService.Utilities;
using Senparc.Weixin.Open.ComponentAPIs;
using Senparc.Weixin.MP.AdvancedAPIs;

namespace WeiXin.CommonService.MessageHandlers.OpenMessageHandler
{
    /// <summary>
    /// 开放平台全网发布之前需要做的验证
    /// </summary>
